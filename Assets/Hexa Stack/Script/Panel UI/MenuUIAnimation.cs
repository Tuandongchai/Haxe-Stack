...
public class MenuUIAnimation : BaseUI
{
    [Header("Element")]
    ...
    [SerializeField] private GameObject cloud0, cloud1, attendace, dailyQuest;
...
/*    [SerializeField] private GameObject bg;*/
    ...
    public override void LoadIn()
    {
        ...
        LeanTween.moveLocalX(cloud0, -546, duration).setEase(LeanTweenType.easeInBack);
        LeanTween.moveLocalX(cloud1, 278, duration).setEase(LeanTweenType.easeInBack);

        LeanTween.moveLocalX(dailyQuest, 442, duration).setEase(LeanTweenType.easeInBack);
        LeanTween.moveLocalX(attendace, 442, duration).setEase(LeanTweenType.easeInBack);
        GameObject[] a = new GameObject[] { avata, settingButton, gold, heath};
        foreach (GameObject go in a)
        {
            LeanTween.moveLocalY(go, 995, duration).setEase(LeanTweenType.easeInBack);
        }
        Show();
    }
    public override void LoadOut()
    {
        ...
        LeanTween.moveLocalX(cloud0, -1000, duration).setEase(LeanTweenType.easeInBack);
        LeanTween.moveLocalX(cloud1, 1000, duration).setEase(LeanTweenType.easeInBack);

        LeanTween.moveLocalX(dailyQuest, 600, duration).setEase(LeanTweenType.easeInBack);
        LeanTween.moveLocalX(attendace, 600, duration).setEase(LeanTweenType.easeInBack);
        GameObject[] a = new GameObject[] { avata, settingButton, gold, heath};
        foreach (GameObject go in a)
        {
    ...
    public override void Show()
    {
        ...
        goldText.text = base.currentGold.ToString();
